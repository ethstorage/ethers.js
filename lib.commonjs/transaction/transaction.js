...
const bloblist_js_1 = require("./bloblist.js");
const BN_0 = BigInt(0);
const BN_2 = BigInt(2);
...
function handleBlobList(value, param) {
    try {
        return (0, bloblist_js_1.blobListify)(value);
    }
    catch (error) {
        (0, index_js_3.assertArgument)(false, error.message, param, value);
    }
...
function handleBlobOtherList(value, param) {
    try {
        return (0, bloblist_js_1.blobOtherListify)(value);
    }
    catch (error) {
        (0, index_js_3.assertArgument)(false, error.message, param, value);
    }
...
function _parseEip4844(data) {
    const fields = (0, index_js_3.decodeRlp)((0, index_js_3.getBytes)(data).slice(1));
    (0, index_js_3.assertArgument)(Array.isArray(fields) &&
        ((fields.length === 4 && Array.isArray(fields[0]) && (fields[0].length === 11 || fields[0].length === 14)) ||
            (fields.length === 11 || fields.length === 14)), "invalid field count for transaction type: 3", "data", (0, index_js_3.hexlify)(data));
    let tx;
    if (fields.length === 4) {
        tx = {
            type: 3,
            ...
            data: (0, index_js_3.hexlify)(fields[0][7]),
    ...
    if (fields.length === 4) {
        tx.hash = (0, index_js_2.keccak256)((0, index_js_3.concat)(["0x03", (0, index_js_3.encodeRlp)(fields[0])]));
...
function _serializeAllEip4844(tx, sig) {
    ...
    return (0, index_js_3.concat)(["0x03", (0, index_js_3.encodeRlp)([fields, blobs, commitments, proofs])]);
}
/**
...
class Transaction {
    ...
    set blobs(value) {
        this.#blobs = (value == null) ? null : (0, bloblist_js_1.blobListify)(value);
    }
    get kzgCommitments() {
    ...
    set kzgCommitments(value) {
        this.#kzgCommitments = (value == null) ? null : (0, bloblist_js_1.blobOtherListify)(value);
    }
    get kzgProofs() {
    ...
    set kzgProofs(value) {
        this.#kzgProofs = (value == null) ? null : (0, bloblist_js_1.blobOtherListify)(value);
    }
    get versionedHashes() {
    ...
    set versionedHashes(value) {
        this.#versionedHashes = (value == null) ? null : (0, bloblist_js_1.blobOtherListify)(value);
    }
    /**
    ...
    get hash() {
        ...
        return (0, index_js_2.keccak256)(this.serializedNormal);
    }
    /**
